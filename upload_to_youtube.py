"""
YouTube Upload Script for Velocity Filipino
"""
...
def ensure_playlist(youtube, title="Learn Filipino Phrases for Beginners | Velocity Filipino", description="All filipino phrases videos in one playlist. 🇵🇭 Learn Filipino with Velocity Filipino!"):
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Filipino with Velocity Filipino"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Filipino", "Filipino Phrases", "Filipino Language", "Velocity Filipino", "Filipino for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY FILIPINO - YOUTUBE UPLOADER")
